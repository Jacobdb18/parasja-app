...
<head>
    ...
    <link rel="stylesheet" href="/parasja/assets/css/style.css">
</head>
<body>
...
<nav class="navbar">
    ...
    <ul class="nav-links">
        <li><a href="/parasja/" class="<?= ($activePage ?? '') === 'home' ? 'active' : '' ?>">
            <svg viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9,22 9,12 15,12 15,22"/></svg>
            Huidig
        </a></li>
        <li><a href="/parasja/archief.php" class="<?= ($activePage ?? '') === 'archief' ? 'active' : '' ?>">
            <svg viewBox="0 0 24 24"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>
            Archief
        </a></li>
        <li><a href="/parasja/zoeken.php" class="<?= ($activePage ?? '') === 'zoeken' ? 'active' : '' ?>">
